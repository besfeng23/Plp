import { getSupabaseConfigError, isSupabaseConfigured, selectRows } from '../_supabase.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res.status(500).json({ ok: false, error: 'Unable to load notifications', detail: error.message });
  }
}
